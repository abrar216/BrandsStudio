                            ...
                            <div className="pt-4 space-y-4">
                                <div className="flex items-center space-x-2.5">
                                    <button
                                        type="submit"
                                        disabled={processing}
                                        className="flex-grow bg-amber-500 hover:bg-amber-600 disabled:bg-slate-350 text-white text-xs font-black tracking-wider py-4 px-6 rounded-xl shadow-lg transition-all flex items-center justify-center space-x-3 uppercase focus:outline-none"
                                    >
                                    ...
                                    <a
                                        ...
                                        className="bg-emerald-500 hover:bg-emerald-600 text-white p-3.5 rounded-xl shadow-md transition-all hover:scale-105 duration-200 flex items-center justify-center flex-shrink-0 animate-pulse"
