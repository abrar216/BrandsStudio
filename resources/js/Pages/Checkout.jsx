                        ...
                        <div className="bg-white border border-stone-200/60 rounded-none p-4 sm:p-6 space-y-6">
                            ...
                            <div className="pt-4 space-y-4">
                                <button
                                    type="submit"
                                    disabled={processing}
                                    className="w-full bg-black hover:bg-neutral-850 disabled:bg-stone-300 text-white text-[10px] tracking-widest font-black py-4 px-6 rounded-none transition-all flex items-center justify-center space-x-2 uppercase focus:outline-none"
                                >
