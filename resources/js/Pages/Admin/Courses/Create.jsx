...
import { BookOpen, ArrowLeft, Upload, CheckCircle2, Plus } from 'lucide-react';
                    ...
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <div>
                            <h1 className="text-3xl font-black text-white tracking-tighter flex items-center gap-3">
                                <Plus className="hidden" /> Create New Course
                            </h1>
                            <p className="text-gray-500 font-medium">Add a new course to the Academy.</p>
                        </div>
                    </div>
