                        ...
                        <div className="lg:col-span-4 space-y-6 sticky top-28">
                            <div className="bg-white border border-slate-100 rounded-3xl p-4 sm:p-6 shadow-sm space-y-5 sm:space-y-6">
                                ...
                                <div className="mt-4 pt-4 border-t border-slate-100/80">
                                    <a
                                        href="https://wa.me/923194601759?text=Hello%20Brands%20Studio!%20I%20have%20some%20questions%20about%20my%20shopping%20cart."
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="flex items-center justify-center space-x-2 w-full bg-emerald-50 hover:bg-emerald-100/80 text-emerald-700 text-xs font-black tracking-wider py-3 px-6 rounded-xl transition-all uppercase border border-emerald-100/50"
                                    >
