...
export default function AdminLayout({ children, title }) {
    ...
    return (
        <div className="min-h-screen bg-slate-100 dark:bg-slate-900 text-slate-800 dark:text-slate-100 flex flex-col md:flex-row font-sans transition-colors duration-200">
            ...
            <div className="flex-grow flex flex-col min-w-0 bg-slate-100 dark:bg-slate-900 transition-colors duration-200">
                ...
                {/* Sub-page Content */}
                <main className="flex-grow p-6 md:p-8 overflow-y-auto bg-slate-100/50 dark:bg-slate-900/30">
